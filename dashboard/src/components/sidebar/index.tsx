...
import { Home, LogOutIcon, Package, PanelBottom, Settings, ShoppingBag, Users } from "lucide-react";
    ...
    return(
        <div className="flex w-full flex-col bg-muted/40">
                    ...
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="#"
                                className="flex h-9 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground"
                                 >
            ...
            <div className="sm:hidden flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
                ...
                sm:j-auto sm:border-0 sm:bg-transparent sm:px-6">
                    <Sheet>
